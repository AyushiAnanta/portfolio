...
export const arcadeGames = [
  {
    name: "Hangman",
    desc: "Guess the word before you run out of chances",
    color: "#ffdd00",
  ...
  {
    name: "TicTacToe",
    desc: "Classic X vs O — claim the grid",
    color: "#bf5fff",
  ...
  {
    name: "BubbleGame",
    desc: "Hit the right bubbles against the clock",
    color: "#39ff14",
  ...
  {
    name: "BrainyPairs",
    desc: "Flip and match all pairs before time runs out",
    color: "#00f0ff",
